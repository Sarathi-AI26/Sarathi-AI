        ...
        <section className="relative overflow-hidden bg-[#0A2351] pt-24 pb-32 sm:pt-32 sm:pb-40">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 className="mx-auto max-w-4xl text-5xl font-extrabold tracking-tight text-white sm:text-6xl xl:text-7xl">
              Bridging the gap between <span className="text-[#F57D14]">potential</span> and <span className="text-[#F57D14]">placement.</span>
            </h1>
            ...
            <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8 border-t border-slate-100 pt-8">
                  <div>
                    <h4 className="text-4xl font-extrabold text-[#F57D14]">15k+</h4>
                    <p className="mt-2 text-sm font-bold uppercase tracking-wider text-slate-500">Careers Analyzed</p>
                  </div>
                  <div>
                    <h4 className="text-4xl font-extrabold text-[#F57D14]">99%</h4>
                    <p className="mt-2 text-sm font-bold uppercase tracking-wider text-slate-500">AI Match Accuracy</p>
                  </div>
                </div>
              </div>
                  ...
                  <ul className="mt-6 space-y-6">
                    <li className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">AI doesn't judge. It purely analyzes 60 psychological data points to find your true fit.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#F57D14]/20 text-[#F57D14]">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">We don't just give you a label. We give you a year-by-year execution plan.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#F57D14]/20 text-[#F57D14]">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">Our engine is specifically trained on the nuances of the Indian tech and corporate job market.</p>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                { icon: Sparkles, title: "AI Innovation", desc: "Leveraging Gemini 2.5 to process complex psychometric data in real-time.", color: "bg-[#F57D14]" },
                { icon: BrainCircuit, title: "Scientific Rigor", desc: "Built on proven, enterprise-grade psychological frameworks.", color: "bg-indigo-600" },
                { icon: Award, title: "Student First", desc: "Empowering the individual above all else, keeping data private and secure.", color: "bg-emerald-600" }
              ].map((value, i) => (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="mx-auto max-w-4xl rounded-[3rem] bg-[#0A2351] p-10 text-center shadow-2xl sm:p-20 relative overflow-hidden">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
                Stop guessing about your future. Take the 15-minute AI-powered psychometric assessment and get your personalized roadmap today.
              </p>
              <div className="mt-10 flex justify-center">
                <Button asChild className="h-14 rounded-full bg-[#F57D14] px-10 text-lg font-bold text-white hover:bg-[#dd6f11] shadow-lg shadow-[#F57D14]/20 transition-transform hover:scale-105">
