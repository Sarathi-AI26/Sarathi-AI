  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
      <div className="container mx-auto flex h-24 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/* 🧭 EXPANDED NAVIGATION WITH GLOBAL ANCHORS */}
        <nav className="hidden items-center gap-8 xl:flex">
          ...
          {/* 🚀 FIX: Notice the "/" before the "#" here! This forces it to the Home page first */}
          ...
          <Link href="/#contact" className="text-sm font-semibold text-[#0A2351] hover:text-[#F57D14] transition-colors">
            Contact
          </Link>
        </nav>
